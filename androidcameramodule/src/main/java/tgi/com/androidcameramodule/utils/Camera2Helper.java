...
//    private ResizableSurfaceView textureView;
...
//
//    private Camera2Helper(Activity act, ResizableSurfaceView view) {
//    }
//
//    private Camera2Helper(Activity act, ResizableSurfaceView view, File file) {
//        activity = act;
//        textureView = view;
//        mFile = file;
...
//    }
//
//    public static Camera2Helper getInstance(Activity act, ResizableSurfaceView view, File file) {
//        if (singleton == null) {
...
//                    textureView.resize(mPreviewSize.getWidth(), mPreviewSize.getHeight());
//                } else {
//                    textureView.resize(mPreviewSize.getHeight(), mPreviewSize.getWidth());
//                }
//                // 设置是否支持闪光灯
